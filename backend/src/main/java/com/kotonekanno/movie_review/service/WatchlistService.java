...
import com.kotonekanno.movie_review.repository.WatchlistItemRepository;
...
public class WatchlistService {
  ...
  public List<WatchlistItemDTO> getAll(User user, int page) {
    int pageSize = 10;
    ...
    Pageable pageable = PageRequest.of(
        safePage - 1,
        pageSize,
        Sort.by(Sort.Direction.DESC, "priority")   // 選択肢化
    );

    return watchlistItemRepository.findWatchlistItemDTOs(user.getId(), pageable);
  }
